  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0">
      <h1 className="text-2xl md:text-7xl font-bold text-black dark:text-white">
        Ne rêvez plus votre site.
      </h1>
      <h2 className="text-2xl md:text-5xl font-semibold text-black dark:text-white">
        Créez-le aujourd’hui.
      </h2>
      <p className="max-w-2xl text-base md:text-xl mt-8 text-black dark:text-neutral-200">
        ...
        Obtenez un site web performant qui génère des résultats.
      </p>
    </div>
  )
}
...
export const ProductCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 h-full w-full opacity-0 group-hover/product:opacity-80 bg-white/80 dark:bg-black pointer-events-none"></div>
